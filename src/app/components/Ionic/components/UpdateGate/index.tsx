                  ...
                  <CheckBox
                    ...
                    label={
                      <Paragraph size="small" fill>
                        {t(
                          'mobileUpdate.disableUpdateGateCheck',
                          'Permanently disable this error notification. Update checks will still work when available. You can re-enable this in profile settings.',
                        )}
                      </Paragraph>
                    }
