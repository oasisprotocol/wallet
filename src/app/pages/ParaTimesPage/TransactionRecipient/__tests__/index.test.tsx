...
describe('<TransactionRecipient />', () => {
  ...
  it('should require an address on form submit', () => {
  ...
  it('should validate an address on form submit', () => {
    const navigateToSummary = jest.fn()
    jest.mocked(useParaTimes).mockReturnValue({
      ...mockUseParaTimesResult,
      transactionForm: {
  ...
  it('should navigate to amount selection step when address is valid', () => {
  ...
  it('should navigate back to deposit', () => {
  ...
  it('should navigate back to withdraw', () => {
