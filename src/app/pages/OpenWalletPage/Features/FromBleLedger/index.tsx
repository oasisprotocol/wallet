...
import {selectShowAccountsSelectionModal, selectShowBleLedgerDevicesModal,} from 'app/state/importaccounts/selectors'
...
export function FromBleLedger() {
  ...
  return (
    ...
    >
      ...
      <ol>
        <li>Connect your Ledger to the device</li>
        <li>Make sure your Ledger is paired with the device</li>
        <li>Close Ledger Live app on the device</li>
        <li>Open the Oasis App on your Ledger device</li>
      </ol>
