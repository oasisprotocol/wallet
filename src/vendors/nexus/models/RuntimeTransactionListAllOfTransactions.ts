...
/**
 * Check if a given object implements the RuntimeTransactionListAllOfTransactions interface.
 */
export function instanceOfRuntimeTransactionListAllOfTransactions(value: object): value is RuntimeTransactionListAllOfTransactions {
...
export function RuntimeTransactionListAllOfTransactionsFromJSON(json: any): RuntimeTransactionListAllOfTransactions {
    return RuntimeTransactionListAllOfTransactionsFromJSONTyped(json, false);
}

export function RuntimeTransactionListAllOfTransactionsFromJSONTyped(json: any, ignoreDiscriminator: boolean): RuntimeTransactionListAllOfTransactions {
    if (json == null) {
        return json;
    }
    return {
...
export function RuntimeTransactionListAllOfTransactionsToJSON(json: any): RuntimeTransactionListAllOfTransactions {
    return RuntimeTransactionListAllOfTransactionsToJSONTyped(json, false);
}

export function RuntimeTransactionListAllOfTransactionsToJSONTyped(value?: RuntimeTransactionListAllOfTransactions | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
