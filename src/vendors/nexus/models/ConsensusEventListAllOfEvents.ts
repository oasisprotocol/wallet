...
/**
 * Check if a given object implements the ConsensusEventListAllOfEvents interface.
 */
export function instanceOfConsensusEventListAllOfEvents(value: object): value is ConsensusEventListAllOfEvents {
...
export function ConsensusEventListAllOfEventsFromJSON(json: any): ConsensusEventListAllOfEvents {
    return ConsensusEventListAllOfEventsFromJSONTyped(json, false);
}

export function ConsensusEventListAllOfEventsFromJSONTyped(json: any, ignoreDiscriminator: boolean): ConsensusEventListAllOfEvents {
    if (json == null) {
        return json;
    }
    return {
...
export function ConsensusEventListAllOfEventsToJSON(json: any): ConsensusEventListAllOfEvents {
    return ConsensusEventListAllOfEventsToJSONTyped(json, false);
}

export function ConsensusEventListAllOfEventsToJSONTyped(value?: ConsensusEventListAllOfEvents | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
