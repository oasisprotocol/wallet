 ...
 * 
 * @export
 * @interface ValidatorListAllOfValidators
 */
export interface ValidatorListAllOfValidators {
    /**
     * The staking address identifying this validator.
     * @type {string}
     * @memberof ValidatorListAllOfValidators
     */
...
/**
 * Check if a given object implements the ValidatorListAllOfValidators interface.
 */
export function instanceOfValidatorListAllOfValidators(value: object): value is ValidatorListAllOfValidators {
...
export function ValidatorListAllOfValidatorsFromJSON(json: any): ValidatorListAllOfValidators {
    return ValidatorListAllOfValidatorsFromJSONTyped(json, false);
}

export function ValidatorListAllOfValidatorsFromJSONTyped(json: any, ignoreDiscriminator: boolean): ValidatorListAllOfValidators {
    if (json == null) {
        return json;
    }
    return {
...
export function ValidatorListAllOfValidatorsToJSON(json: any): ValidatorListAllOfValidators {
    return ValidatorListAllOfValidatorsToJSONTyped(json, false);
}

export function ValidatorListAllOfValidatorsToJSONTyped(value?: ValidatorListAllOfValidators | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
