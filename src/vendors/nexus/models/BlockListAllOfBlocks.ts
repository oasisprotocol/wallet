 ...
 * 
 * @export
 * @interface BlockListAllOfBlocks
 */
export interface BlockListAllOfBlocks {
    /**
     * The block height.
     * @type {number}
...
/**
 * Check if a given object implements the BlockListAllOfBlocks interface.
 */
export function instanceOfBlockListAllOfBlocks(value: object): value is BlockListAllOfBlocks {
...
export function BlockListAllOfBlocksFromJSON(json: any): BlockListAllOfBlocks {
    return BlockListAllOfBlocksFromJSONTyped(json, false);
}

export function BlockListAllOfBlocksFromJSONTyped(json: any, ignoreDiscriminator: boolean): BlockListAllOfBlocks {
    if (json == null) {
        return json;
    }
    return {
...
export function BlockListAllOfBlocksToJSON(json: any): BlockListAllOfBlocks {
    return BlockListAllOfBlocksToJSONTyped(json, false);
}

export function BlockListAllOfBlocksToJSONTyped(value?: BlockListAllOfBlocks | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
