...
export interface ValidatorRow {
    ...
    /**
     * If "active", an entity has a node that is registered for being a validator, node is up to date, and has successfully registered itself. However, it may or may not be part of validator set (top 110).
     * @type {string}
     * @memberof ValidatorRow
     */
